...
public class UiAutomationTrainingBasicTest extends TestBase {
	...
	public void testVerifyCheckBox() {
		...
		softAssert.assertTrue(CheckBoxPage.isCheckBoxPageDisplayed(), "Check box Page is not Displayed");
		softAssert.assertTrue(CheckBoxPage.isCheckBox1Displayed(), "Check box1 is not Displayed");
		softAssert.assertTrue(CheckBoxPage.isCheckBox2Displayed(), "Check box2 is not Displayed");
		CheckBoxPage.checkCheckBox1();
		softAssert.assertTrue(CheckBoxPage.isCheckBox1Checked(), "Check box1 is not checked");
		CheckBoxPage.unCheckCheckBox1();
		softAssert.assertFalse(CheckBoxPage.isCheckBox1Checked(), "Check box1 is Displayed");
		CheckBoxPage.checkCheckBox2();
		softAssert.assertTrue(CheckBoxPage.isCheckBox2Checked(), "Check box2 is not checked");
		CheckBoxPage.unCheckCheckBox2();
		softAssert.assertFalse(CheckBoxPage.isCheckBox2Checked(), "Check box2 is Displayed");
